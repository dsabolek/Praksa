	...
	public function add_settings_link( $links ) {
		...
		array_unshift(
			...
			sprintf(
				...
				esc_html( __( 'Upgrade', 'smartcrawl-seo' ) )
			)
		);
		...
		array_unshift(
			...
			sprintf(
				...
				esc_html( __( 'Settings', 'smartcrawl-seo' ) )
			)
		);
	...
	public function plugin_row_meta( $plugin_meta, $plugin_file ) {
		if ( SMARTCRAWL_PLUGIN_BASENAME === $plugin_file ) {
			...
			$row_meta = array(
				...
				'support' => '<a href="https://wordpress.org/support/plugin/smartcrawl-seo/" target="_blank">' . esc_html__( 'Premium Support', 'smartcrawl-seo' ) . '</a>',
