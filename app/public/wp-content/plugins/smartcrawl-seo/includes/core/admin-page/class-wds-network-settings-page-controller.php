...
class Smartcrawl_Network_Settings_Page_Controller extends Smartcrawl_Admin_Page {
	...
	public function options_page() {
		$arguments['slugs']                = array(
			Smartcrawl_Settings::TAB_ONPAGE    => __( 'Title & Meta', 'smartcrawl-seo' ),
			Smartcrawl_Settings::TAB_SCHEMA    => __( 'Schema', 'smartcrawl-seo' ),
			Smartcrawl_Settings::TAB_SOCIAL    => __( 'Social', 'smartcrawl-seo' ),
			Smartcrawl_Settings::TAB_SITEMAP   => __( 'Sitemaps', 'smartcrawl-seo' ),
			Smartcrawl_Settings::TAB_AUTOLINKS => __( 'Advanced Tools', 'smartcrawl-seo' ),
			Smartcrawl_Settings::TAB_SETTINGS  => __( 'Settings', 'smartcrawl-seo' ),
		);
