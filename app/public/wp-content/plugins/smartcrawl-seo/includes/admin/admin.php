...
class Smartcrawl_Admin extends Smartcrawl_Base_Controller {
	...
	public function add_toolbar_items( $admin_bar ) {
		...
		if ( ! empty( $optional_nodes ) ) {
			$admin_bar->add_node( $this->create_admin_bar_node( Smartcrawl_Settings::TAB_DASHBOARD, __( 'SmartCrawl', 'smartcrawl-seo' ) ) );
			$admin_bar->add_node( $this->create_admin_bar_node( Smartcrawl_Settings::TAB_DASHBOARD . '_dashboard', __( 'Dashboard', 'smartcrawl-seo' ), Smartcrawl_Settings::TAB_DASHBOARD ) );
