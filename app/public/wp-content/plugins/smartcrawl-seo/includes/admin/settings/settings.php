...
class Smartcrawl_Settings_Settings extends Smartcrawl_Settings_Admin {
	...
	protected function get_filtered_roles( $context_filter = false ) {
		$default_roles = array(
			...
			'list_users'           => sprintf( __( '%s (and up)', 'smartcrawl-seo' ), __( 'Site Admin', 'smartcrawl-seo' ) ),
			/* translators: %s: Role name */
	...
	private function get_plugin_modules() {
		...
		$all_plugin_modules = array(
			'onpage'    => $this->plugin_module_args( __( 'Title & Meta', 'smartcrawl-seo' ), 'onpage' ),
			...
			'social'    => $this->plugin_module_args( __( 'Social', 'smartcrawl-seo' ), 'social' ),
			'sitemap'   => $this->plugin_module_args( __( 'Sitemaps', 'smartcrawl-seo' ), 'sitemap' ),
			'autolinks' => $this->plugin_module_args( __( 'Advanced Tools', 'smartcrawl-seo' ), 'autolinks' ),
		);
