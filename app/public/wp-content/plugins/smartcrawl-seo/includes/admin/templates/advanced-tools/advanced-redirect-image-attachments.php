...
<div class="sui-form-field">
	<label for="redirect-attachments-images_only" class="sui-checkbox">
		...
		<span id="label-redirect-attachments-images_only">
			<?php esc_html_e( 'Redirect image attachments only', 'smartcrawl-seo' ); ?>
		</span>
	</label>

	<p class="sui-description" style="margin-left: 25px;">
		<?php esc_html_e( 'Select this option if you only want to redirect attachments that are an image.', 'smartcrawl-seo' ); ?>
	</p>
</div>
