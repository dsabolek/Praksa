...
<form action="<?php echo esc_attr( $_view['action_url'] ); ?>" method="post" class="wds-form">
	...
	<p>
		<?php esc_html_e( 'Search engines use web crawlers (bots) to explore and index the internet. A robots.txt file is a critical text file that tells those bots what they can and can’t index, and where things are.', 'smartcrawl-seo' ); ?>
	</p>
	...
	$this->render_view(
		...
		array(
			...
			'message' => smartcrawl_format_link(
				...
				esc_html__( 'Your robots.txt is active and visible to bots. You can view it at %s', 'smartcrawl-seo' ),
	...
	<div class="sui-box-settings-row">
		<div class="sui-box-settings-col-1">
			<label class="sui-settings-label"><?php esc_html_e( 'Output', 'smartcrawl-seo' ); ?></label>
			<p class="sui-description"><?php esc_html_e( 'Here’s a preview of your current robots.txt output. Customize your robots.txt file below.', 'smartcrawl-seo' ); ?></p>
		</div>

		<div class="sui-box-settings-col-2">
			<label for="robots-preview" class="sui-label"><?php esc_html_e( 'Robots.txt preview', 'smartcrawl-seo' ); ?></label>
			<textarea
				id="robots-preview"
				readonly="readonly"
	...
	<div class="sui-box-settings-row">
		<div class="sui-box-settings-col-1">
			<label class="sui-settings-label"><?php esc_html_e( 'Include Sitemap', 'smartcrawl-seo' ); ?></label>
			<p class="sui-description"><?php esc_html_e( 'It’s really good practice to instruct search engines where to find your sitemap. If enabled, we will automatically add the required code to your robots file.', 'smartcrawl-seo' ); ?></p>
		</div>
		...
		<div class="sui-box-settings-col-2">
			...
			$this->render_view(
				...
				array(
					...
					'item_label'                 => esc_html__( 'Link to my Sitemap', 'smartcrawl-seo' ),
					'inverted'                   => true,
	...
	<div class="sui-box-settings-row">
		<div class="sui-box-settings-col-1">
			<label class="sui-settings-label"><?php esc_html_e( 'Customize', 'smartcrawl-seo' ); ?></label>
			<p class="sui-description wds-documentation-link">
				<?php
				echo smartcrawl_format_link(
					/* translators: %s: Url to robots.txt documentation */
					esc_html__( 'Customize the robots.txt output here. We have %s on a range of examples and options for your robots.txt file.', 'smartcrawl-seo' ),
					'https://wpmudev.com/docs/wpmu-dev-plugins/smartcrawl/#robots-txt-editor',
					esc_html__( 'full documentation', 'smartcrawl-seo' ),
					'_blank'
				);
				?>
			</p>
		...
		<div class="sui-box-settings-col-2">
			<label
				...
				class="sui-label"><?php esc_html_e( 'Edit your robots.txt file', 'smartcrawl-seo' ); ?></label>
			<textarea
	...
	<div class="sui-box-settings-row">
		<div class="sui-box-settings-col-1">
			...
			<p class="sui-description">
				<?php esc_html_e( 'No longer need a Robots.txt file? This will deactivate this feature and remove the file.', 'smartcrawl-seo' ); ?>
			</p>
		</div>
		<div class="sui-box-settings-col-2">
			<button
