...
<label
	...
	class="sui-label"><?php esc_html_e( 'Sitemap URL', 'smartcrawl-seo' ); ?></label>
	...
	if ( Smartcrawl_Sitemap_Utils::override_native() ) {
		$this->render_view(
			...
			array(
				...
				'message' => esc_html__( "We've detected you're using SmartCrawl's built in sitemap and will output this for you automatically.", 'smartcrawl-seo' ),
			)
		);
	}
	?>
<?php else : ?>
	...
	<p class="sui-description">
		...
		printf(
			...
			esc_html__( 'Copy and paste the URL to your sitemap. E.g %1$s or %2$s', 'smartcrawl-seo' ),
