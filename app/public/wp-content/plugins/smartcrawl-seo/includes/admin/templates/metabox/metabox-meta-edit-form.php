...
<div class="wds-edit-meta">
	...
	<div class="sui-border-frame" style="display: none;">
		<?php if ( apply_filters( 'wds-metabox-visible_parts-title_area', true ) ) : ?>
			<div class="sui-form-field">
				<label class="sui-label" for="wds_title">
					...
					<?php /* translators: 1, 2: Min/max length */ ?>
					<span><?php echo esc_html( sprintf( __( '- Include your focus keywords. %1$d-%2$d characters recommended.', 'smartcrawl-seo' ), smartcrawl_title_min_length(), smartcrawl_title_max_length() ) ); ?></span>
				</label>
		...
		<?php if ( apply_filters( 'wds-metabox-visible_parts-description_area', true ) ) : ?>
			<div class="sui-form-field">
				<label class="sui-label sui-insert-variables-label" for="wds_metadesc">
					<?php esc_html_e( 'Description', 'smartcrawl-seo' ); ?>
					<?php /* translators: 1, 2: Min/max length */ ?>
					<span><?php echo esc_html( sprintf( __( '- Recommended minimum of %1$d characters, maximum %2$d.', 'smartcrawl-seo' ), smartcrawl_metadesc_min_length(), smartcrawl_metadesc_max_length() ) ); ?></span>
				</label>
				<div class="sui-insert-variables wds-allow-macros">
					<textarea
						rows='2'
		...
		<p class="sui-description"><?php esc_html_e( 'Update or publish this page to save your changes.', 'smartcrawl-seo' ); ?></p>
	</div>
</div>
