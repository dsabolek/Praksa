...
$this->render_view(
	...
	array(
		...
		'description' => esc_html__( 'Add a shortcut to SmartCrawl settings in the top WordPress Admin bar.', 'smartcrawl-seo' ),
		'separator'   => true,
		'items'       => array(
			'extras-admin_bar' => array(
				'label'            => esc_html__( 'Enable SmartCrawl shortcut', 'smartcrawl-seo' ),
				'html_description' =>
					'<span class="sui-description">' . smartcrawl_format_link(
						/* translators: %s: Link to User Roles tab */
						esc_html__( 'Note: Only user roles defined in the %s tab will be able to see this.', 'smartcrawl-seo' ),
						Smartcrawl_Settings_Admin::admin_url( Smartcrawl_Settings::TAB_SETTINGS ) . '&tab=tab_user_roles',
						esc_html__( 'User Roles', 'smartcrawl-seo' )
					) . '</span>',
			),
		),
	)
...
<div class="sui-box-settings-row">
	<div class="sui-box-settings-col-1">
		...
		<p class="sui-description">
			<?php esc_html_e( 'Choose which modules you would like to activate.', 'smartcrawl-seo' ); ?>
		</p>
	</div>
