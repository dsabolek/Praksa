...
$file = fopen($n_dok, 'w');
$header = array( "id narudzbe", "datum narudzbe", "podaci o kupcu", "podaci o dostavi", 
"podaci o placanju", "status narudzbe", "podaci o proizvodima");
fputcsv($file, $header);
